...
FileController::FileController(QSettings* settings, const QByteArray &_docroot, QObject* parent)
...
void FileController::setContentType(QString filename, HttpResponse& response) {
